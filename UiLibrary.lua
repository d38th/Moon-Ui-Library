...
getgenv().kms = false
local Ihatethisui = {}
local UIName = 'Moon Ui Library | .gg/MoonScripts'
local Amount = 0
local ConfigF
...
local Themes = {
    ...
    ['Murple'] = {
        ...
        SidebarColor = Color3.fromRGB(25, 29, 43),
        PrimaryTextColor = Color3.fromRGB(255, 255, 255),
        SecondaryTextColor = Color3.fromRGB(132, 123, 179),
        UIStrokeColor = Color3.fromRGB(21, 23, 35),
        PrimaryElementColor = Color3.fromRGB(23, 26, 39),
        SecondaryElementColor = Color3.fromRGB(23, 26, 39),
        OtherElementColor = Color3.fromRGB(23, 26, 39),
...
do
    ...
    function Library:CreateNotification(Title, Text, Duration)
        local Theme = {}
        local File = readfile('MoonUILibraryCurrentTheme.json')
        ...
        task.spawn(function()
            ...
            if not CoreGui:FindFirstChild('Moon UI Library | .gg/MoonScripts | Notifications') then
                Utility:Create('ScreenGui', {
                    Name = 'Moon UI Library | .gg/MoonScripts | Notifications',
                    Parent = CoreGui
                })
            else
                Utility:Create('Frame', {
                    Parent = CoreGui:FindFirstChild('Moon UI Library | .gg/MoonScripts | Notifications'),
...
function Library:SetTransparency(Transparency, NotificationBool)
    local UI = CoreGui:WaitForChild('Moon UI Library | .gg/MoonScripts')
    local Blacklist = {
        'UIPadding',
        'UICorner',
        'UIStroke',
...
function Library:CreateWindow(HubName, GameName, IntroText, IntroIcon, ImprovePerformance, ConfigFolder, Theme)
    ...
    if isfile('MoonUILibraryCurrentTheme.json') then
        delfile('MoonUILibraryCurrentTheme.json')
    end
